...
- NEVER modify test files. If a test seems wrong or unimplementable, STOP and report the problem instead of "fixing" the test. The ONLY exception is if you deal with documented regressions/bugs and the tests are marked as XFAIL or "skip" or "assertStillBroken" or simillar.
