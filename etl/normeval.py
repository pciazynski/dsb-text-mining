...
bl = {}
incons = 0
with open (datadir+"normmapping/_all.txt", "r", encoding="utf8") as bwin, open (datadir+"normmapping/_inconsistencies.txt", "w", encoding="utf8") as incout:
    for line in bwin:
        linearr = line.split("\t")
        if linearr[0] in bl:
...
nay = 0
progress = {}
with open (datadir+"bagofwords/_all.txt", "r", encoding="utf8") as bwin, open (datadir+"normmapping/_yay.txt", "w", encoding="utf8") as outyay,open (datadir+"normmapping/_nay.txt", "w", encoding="utf8") as outnay:
    for line in bwin:
        linearr = line.split("\t")
        if linearr[0] in bl:
            outyay.write(line)
...
with open (datadir+"normmapping/_progress.txt", "w", encoding="utf8") as outlemprogress:
