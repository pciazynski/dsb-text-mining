...
function embedding(iframeid) {
  alert(
    '<iframe height=' +
      document.getElementById(iframeid).offsetHeight +
      ' width=' +
      document.getElementById(iframeid).offsetWidth +
      ' src="' +
...
var switchLogScale = function (elementid) {
  loading(elementid);
  url = document.getElementById(elementid).src;
  if (url.includes('&scale=log')) {
    url = url.replaceAll('&scale=log', '');
  } else {
    url += '&scale=log';
  }
  document.getElementById(elementid).src = url;
...
var threeD = function (iframeid) {
  ...
  if (el.src.includes('3d.html')) {
    el.src = el.src.replace('3d.html', '.html');
  } else {
    el.src = el.src.replace('.html', '3d.html');
  }
};
...
function language(elementid) {
  url = document.getElementById(elementid).src;
  if (url.includes('&lang=DEU')) {
    url = url.replace('&lang=DEU', '');
  } else {
    url += '&lang=DEU';
  }
  document.getElementById(elementid).src = url;
...
function hidewatermark(elementid) {
  url = document.getElementById(elementid).src;
  if (url.includes('&hidewatermark=1')) {
    url = url.replace('&hidewatermark=1', '');
  } else {
    url += '&hidewatermark=1';
  }
  document.getElementById(elementid).src = url;
...
function header() {
  ...
  if (headerconftmp.length == 6) {
    headerconf = headerconftmp;
  }
  str = '<div class="header">' + '<table>' + '<tr style="text-align:center;">';
  if (headerconf[0] !== '0') {
    str +=
      '<td>' +
      lang_metadata +
      '&nbsp;<a style="color:black;" href=".?headerconf=' +
      hidemenu(headerconf, 0) +
      '"><sup title="' +
      lang_closemenu +
      '">&#10006;</sup></a></td>';
  }
  ...
  if (headerconf[2] !== '0') {
    str +=
      '<td><a href="../characters?headerconf=' +
      headerconf +
      '">' +
      lang_characters +
      '</a>&nbsp;<a  style="color:black;" href=".?headerconf=' +
      hidemenu(headerconf, 2) +
      '"><sup title="' +
      lang_closemenu +
      '">&#10006;</sup></a></td>';
  }
  ...
  str +=
    '<td><a href="' +
    ctsurl.substring(0, ctsurl.length - 4) +
    'plain/editions.php">' +
    lang_textapi +
    '</a></td>';
  ...
  if (headerconf[3] !== '0') {
    str +=
      '<td>' +
      '<a href="../bwlemma?headerconf=' +
      headerconf +
      '">' +
      lang_timeline +
      '</a> | ' +
      '<a href="../lemmavariation?headerconf=' +
      headerconf +
      '">' +
      lang_variation +
      '</a> | ' +
      '<a href="../lemmaeval?headerconf=' +
      headerconf +
      '">' +
      lang_evaluation +
      '</a> | ' +
      '<a href="../profile?headerconf=' +
      headerconf +
      '">' +
      lang_profile +
      '</a>' +
  ...
  if (headerconf.includes('0')) {
    str += '<a  style="color:black;" href=".">' + lang_resetmenu + '</a>';
  }
  str += '</td>' + '</tr>' + '</table>' + '</div>';
